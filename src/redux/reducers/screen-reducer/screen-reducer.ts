  ...
  sprites: {
    ...
    informationFields: {
      informationFieldsItems: [
        {position: {x: 54, y: 28}, meta: {id: "133000", description: "T gas"}, spec: {signalId: "gas_temp"}},
        {position: {x: 54, y: 30}, meta: {id: "133001", description: "P gas"}, spec: {signalId: "gas_pressure"}},
        {position: {x: 54, y: 32}, meta: {id: "133002", description: "Q gas"}, spec: {signalId: "gas_rate"}},
        {position: {x: 54, y: 15}, meta: {id: "133003", description: "T steam"}, spec: {signalId: "steam_temp"}},
        {position: {x: 54, y: 17}, meta: {id: "133004", description: "P steam"}, spec: {signalId: "steam_pressure"}},
        {position: {x: 54, y: 19}, meta: {id: "133005", description: "Q steam"}, spec: {signalId: "steam_rate"}},
        {position: {x: 54, y: 5}, meta: {id: "133006", description: "T water"}, spec: {signalId: "water_temp"}},
        {position: {x: 54, y: 7}, meta: {id: "133007", description: "P water"}, spec: {signalId: "water_pressure"}},
        {position: {x: 54, y: 9}, meta: {id: "133008", description: "Q water"}, spec: {signalId: "water_rate"}},
        {position: {x: 4, y: 5}, meta: {id: "133009", description: "RPM"}, spec: {signalId: "air_fan_rpm"}},
        {position: {x: 4, y: 7}, meta: {id: "133010", description: "T flue gas"}, spec: {signalId: "smoke_temp"}},
        {position: {x: 4, y: 32}, meta: {id: "133011", description: "RPM"}, spec: {signalId: "smoke_fan_rmp"}},
        {position: {x: 23, y: 29}, meta: {id: "133012", description: "Underpressure"}, spec: {signalId: "burner_pressure"}},
        {position: {x: 33, y: 29}, meta: {id: "133013", description: "Flame"}, spec: {signalId: "burner_flame"}},
        {position: {x: 35, y: 10}, meta: {id: "133014", description: "Level"}, spec: {signalId: "boiler_level"}},
      ],
    }
  },
}
